...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Process root directory and prefix inputs."
    )
    parser.add_argument("--root-dir", type=str, help="Root directory", required=True)
    parser.add_argument(
        "--prefix-source", type=str, help="Prefix source link", required=True
    )
    parser.add_argument(
        "--new-prefix-source", type=str, help="New prefix source", required=True
    )
